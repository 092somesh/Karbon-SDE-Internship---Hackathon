...
def total_revenue(data: dict, financial_index):
    ...
    net_revenue = financial_entry["pnl"]["lineItems"]["net_revenue"]
    # print(net_revenue)
    return net_revenue
...
def total_borrowing(data: dict, financial_index):
    ...
    borrowing_sum = financial_entry["bs"]["liabilities"]["long_term_borrowings"] + financial_entry["bs"]["liabilities"]["short_term_borrowings"]
...
def iscr(data: dict, financial_index):
    ...
    """
    financial_entry = data["financials"][financial_index]
    sum_of_profit = financial_entry["pnl"]["lineItems"]["profit_before_interest_and_tax"] + financial_entry["pnl"]["lineItems"]["depreciation"]+1
    sum_of_interest = financial_entry["pnl"]["lineItems"]["interest"] + financial_entry["pnl"]["lineItems"]["total_other_expenses"]+1
